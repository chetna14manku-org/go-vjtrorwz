...
export IMAGE_URL=${IMAGE_URL-quay.io/chetna14manku_org/go-vjtrorwz:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/chetna14manku-org/go-vjtrorwz-gitops
